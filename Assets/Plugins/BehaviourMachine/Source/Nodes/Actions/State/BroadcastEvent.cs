...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Sends an event to all enabled root FSM in the "Game Object" or any of its children.
    /// </summary>
    [NodeInfo ( category = "Action/State/",
                icon = "StateMachine",
                description = "Sends an event to all enabled root FSM in the \"Game Object\" or any of its children")]
    public class BroadcastEvent : ActionNode {
    	...
    	public override Status Update () {
            ...
            storeEventUsed.Value = blackboard.BroadcastEvent(eventToSend.id);
