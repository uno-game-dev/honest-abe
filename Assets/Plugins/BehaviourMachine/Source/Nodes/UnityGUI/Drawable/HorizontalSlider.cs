...
namespace BehaviourMachine {
    ...
    [NodeInfo(  category = "UnityGUI/Drawable/Layout/",
                ...
                url = "http://docs.unity3d.com/Documentation/ScriptReference/GUILayout.HorizontalSlider.html")]
    public class HorizontalSlider : ActionNode, IGUINode {
    	...
    	public override Status Update () {
            ...
            value.Value = GUILayout.HorizontalSlider(value.Value, leftValue.Value, rightValue.Value);
