...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Returns Success if all BoolVar in "Values" are true; otherwise returns Failure.
    /// </summary>
    [NodeInfo ( category = "Condition/Blackboard/",
                icon = "Blackboard",
                description = "Returns Success if all BoolVars in \"Values\" are true; otherwise returns Failure")]
