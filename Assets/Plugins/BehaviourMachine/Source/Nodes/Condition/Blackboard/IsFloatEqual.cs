...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Returns Success if "A" is equals to "B" with tolerance; returns Failure otherwise.
    /// </summary>
    [NodeInfo ( category = "Condition/Blackboard/",
                icon = "Blackboard",
                description = "Returns Success if \"A\" is equals to \"B\" with tolerance; returns Failure otherwise")]
