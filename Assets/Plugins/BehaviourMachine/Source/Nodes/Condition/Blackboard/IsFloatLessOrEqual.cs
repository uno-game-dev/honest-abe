...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Returns Success if "A" is less than or equals to "B"; returns Failure otherwise.
    /// </summary>
    [NodeInfo ( category = "Condition/Blackboard/",
                icon = "Blackboard",
                description = "Returns Success if \"A\" is less than or equals to \"B\"; returns Failure otherwise")]
