...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Returns Success if "A" is greater than or equal to "B"; returns Failure otherwise.
    /// </summary>
    [NodeInfo ( category = "Condition/Blackboard/",
                icon = "Blackboard",
                description = "Returns Success if \"A\" is greater than or equal to \"B\"; returns Failure otherwise")]
