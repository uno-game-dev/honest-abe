...
namespace BehaviourMachine {
    ...
    /// <summary>
    /// Returns Success if the component in the vector "A" is greater or equal to "B"; Failure otherwise.
    /// </summary>
    [NodeInfo ( category = "Condition/Blackboard/",
                icon = "Blackboard",
                description = "Returns Success if the component in the vector \"A\" is greater or equal to \"B\"; Failure otherwise")]
